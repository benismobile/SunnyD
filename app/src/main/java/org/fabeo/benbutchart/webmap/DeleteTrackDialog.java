 ...
 */
public class DeleteTrackDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Select Track")
                .setItems( tracks != null ? tracks : new String[]{"No tracks found"} ,
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (tracks == null) {
                            ...
                            listener.onDeleteTrack(DeleteTrackDialog.this,tracks[which]);
